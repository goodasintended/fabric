...
public class KeyBindingsTest implements ClientModInitializer {
	...
	public void onInitializeClient() {
		...
		KeyBinding screenBinding = KeyBindingHelper.registerKeyBinding(new KeyBinding("key.fabric-key-binding-api-v1-testmod.test_keybinding_on_screen", InputUtil.Type.KEYSYM, GLFW.GLFW_KEY_O, "key.category.first.test"));
		...
		ClientTickEvents.END_CLIENT_TICK.register(client -> {
			...
			if (KeyBindingHelper.isPressedIgnoreScreen(screenBinding)) {
				client.player.sendMessage(new LiteralText("On Screen Key was pressed!"), false);
			}
